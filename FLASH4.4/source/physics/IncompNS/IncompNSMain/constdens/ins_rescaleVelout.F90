...
#include "Flash.h"
  ...
  use Grid_interface, only : Grid_getDeltas,         &
   ...
   use IncompNS_data, ONLY : ins_meshMe, ins_domainBC
...
!=============================================================================
  ...
  if (any(ins_domainBC(LOW:HIGH,1:NDIM) .eq. NEUMANN_INS) .or. &
      any(ins_domainBC(LOW:HIGH,1:NDIM) .eq. OUTFLOW_INS)) then 
