...
! set the input vector. pipeline is only 1 element long in this example
      temp_row(1) = 1.0d8 ; den_row(1)  = 1.0d2 ; abar_row(1) = abar ; zbar_row(1) = zbar
      jlo_eos = 1 ; jhi_eos = 1
...
! pressure derivative with density
        ...
        write(*,*)'dpepdd',dpepdd,si0t,si1t,si0mt,si1mt
...
! electron chemical potential etaele
        ...
        write(*,*)'etaele',etaele,si0t,si1t,si0mt,si1mt
! derivative with respect to density
        x       = h3(iat,jat, &
                     si0t,   si1t,   si0mt,   si1mt, &
...
! electron + positron number densities
       xnefer   = h3(iat,jat, &
                     si0t,   si1t,   si0mt,   si1mt, &
                     si0d,   si1d,   si0md,   si1md)
       write(*,*)'xnefer',xnefer,si0t,si1t,si0mt,si1mt
! derivative with respect to density
       x        = h3(iat,jat, &
                     si0t,   si1t,   si0mt,   si1mt, &
                    dsi0d,  dsi1d,  dsi0md,  dsi1md)
