...
!       Grid_getBlkIndexLimits, &
       Grid_solvePoisson, Grid_solveAbecLaplacian, &
...
#include "Flash_mpi.h"
  ...
  poisfact=1.
  call Grid_solveAbecLaplacian(NSOL_VAR, RHS_VAR, ALPHACC_VAR, BETACC_VAR, bcTypes, bcValues, poisfact,ascalar,bscalar)
  call mpi_barrier(gr_meshComm,ierr)
